...
# Si tenemos la informacion en un diccionario esta la podemos pasar a la funcion como parametros usando el ** y esto convertira el diccionario en parametros y valores
saludar(**saludo)
...
resultado = creacion_persona(**data)
